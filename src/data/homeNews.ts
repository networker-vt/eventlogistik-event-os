...
export const HOME_NEWS: HomeNewsItem[] = [
  ...
  },
  {
    id: 'hn-e-1',
    cat: 'tech',
    titleDe: 'Streaming-Herbst: Creator und kleine Labels suchen Tour-Crew',
    titleEn: 'Streaming season: creators and small labels look for tour crew',
    source: 'Demo-Kuratierung',
    href: 'https://www.heise.de',
    tags: ['Entertainment', 'Musik', 'Creator', 'Netflix', 'YouTube', 'Spotify'],
  },
  {
    id: 'hn-sh-1',
    cat: 'wirtschaft',
    titleDe: 'Retail-Woche: lokale Läden matchen gegen Marktplatz-Riesen',
    titleEn: 'Retail week: local shops match against marketplace giants',
    source: 'Demo-Kuratierung',
    href: 'https://www.handelsblatt.com',
    tags: ['Shopping', 'Retail', 'Handel', 'Amazon'],
  },
  {
    id: 'hn-f-1',
    cat: 'tech',
    titleDe: 'Look & Fashion: unabhängige Labels suchen Foto- und Style-Partner',
    titleEn: 'Look & fashion: indie labels look for photo and style partners',
    source: 'Demo-Kuratierung',
    href: 'https://www.heise.de',
    tags: ['Fashion', 'Look', 'Instagram', 'Creator'],
  },
]

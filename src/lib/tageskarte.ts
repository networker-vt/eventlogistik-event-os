...
export const TAGESKARTE_POOL: TageskarteItem[] = [
  ...
  // Abend — Look / Laune / Freizeit
  {
    ...
    slot: 'abend',
    themes: ['look'],
    titleDe: 'Look fürs Abendlicht',
    titleEn: 'A look for evening light',
    bodyDe: 'Outfit, Haare, Nearby — Orbit Look ist ein Stub, der Tipp ist frei.',
    bodyEn: 'Outfit, hair, nearby — Orbit Look is a stub; the tip is free.',
    promptDe: 'Neuer Look für heute Abend',
    promptEn: 'A new look for this evening',
    to: '/look',
  },
  {
    id: 'ab-laune-1',
  ...
  },
  {
    ...
    bodyDe: 'Kurzer Style-Rat. Foto optional — Home bleibt frei.',
    bodyEn: 'A short style tip. Photo optional — Home stays free.',
    promptDe: 'Look für morgen früh, einfach halten',
    promptEn: 'A look for tomorrow morning, keep it simple',
    to: '/look',
  },
  {
    id: 'ab-kids-1',
